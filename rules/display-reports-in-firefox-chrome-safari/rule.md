...
::: bad  
![Figure: Bad example - SQL RS does not work in Chrome by default](report-display-bad_1728009845048.jpg)  
:::
...
::: good  
![Figure: Good example - SQL RS fixed to correctly display in Chrome](report-display-good_1728009845049.jpg)
:::
